...
class Sidebar:
    ...
    def create_menu_sidebar(self) -> None:
        ...
        self.main_menu_item("Save 30 Seconds", lambda: self.player.save_capture(30))
        self.main_menu_item("Save 60 Seconds", lambda: self.player.save_capture(60))
        self.main_menu_item("Save 5 Minutes", lambda: self.player.save_capture(300))
        self.main_menu_item("Save 10 Minutes", lambda: self.player.save_capture(600))
